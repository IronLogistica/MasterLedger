...
ACCOUNTS = [
    ...
    ("141000", "Fatture da Emettere",                       "patrimoniale_attivo",   False, None),
...
def run_seed():
    ...
    ACCOUNT_MAPPING_DEFAULTS = [
        ...
        ("fatture_da_emettere",     "141000", "Fatture da Emettere",                     "clienti_fornitori"),
